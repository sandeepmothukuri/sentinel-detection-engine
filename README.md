...
| **Quality gates** | 18 checks in 9 families in `scripts/ci_validate.py`, 206 tests, 6 CI drift gates, secret scanning, SHA-pinned actions |
...
├── tests/                  206 tests, plus the validation ledger and the evidence templates
...
python -m pytest tests -q                # 206 tests, offline, under ten seconds
...
206 tests, no network access required, under ten seconds.
