...
| Python tests | `pytest tests/` (163 tests) | Regressions: parameter parsing patterns, uniqueness, honest validation statuses, JSON artifacts parse, the declared toolchain matches what the gates import |
