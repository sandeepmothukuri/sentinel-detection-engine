...
![IR lifecycle](../images/soar/02-ir-lifecycle.png)

*Generated by `scripts/render_diagrams.py` from `docs/diagrams/soar/02-ir-lifecycle.mmd`. The phases
below are the same loop with the timings, owners and evidence each one owes.*
