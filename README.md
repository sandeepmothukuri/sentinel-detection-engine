...
| **Quality gates** | 18 checks in 9 families in `scripts/ci_validate.py`, 207 tests, 7 CI drift gates, secret scanning, SHA-pinned actions |
...
├── tests/                  207 tests, plus the validation ledger and the evidence templates
...
python -m pytest tests -q                # 207 tests, offline, under ten seconds
...
207 tests, no network access required, under ten seconds.
