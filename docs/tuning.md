...
![Tuning and feedback loop](images/detections/03-tuning-and-feedback-loop.png)

*Generated by `scripts/render_diagrams.py` from `docs/diagrams/detections/03-tuning-and-feedback-loop.mmd`.*
