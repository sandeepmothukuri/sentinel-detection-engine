...
| **Quality gates** | 18 checks in 9 families in `scripts/ci_validate.py`, 196 tests, 6 CI drift gates, secret scanning, SHA-pinned actions |
...
├── tests/                  196 tests, plus the validation ledger and the evidence templates
...
python -m pytest tests -q                # 196 tests, offline, under ten seconds
...
196 tests, no network access required, under ten seconds.
...
playbooks with safety gates; 18-check CI validator; 196-test suite including negative tests;
